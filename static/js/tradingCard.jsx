...
ReactDOM.render(
  <TradingCard name="Merge" skill="furniture repurposing" imgUrl="/static/img/merge.png" />,
  document.querySelector('#merge')
);

ReactDOM.render(
  <TradingCard name="Shortstack" skill="flippin' for real" imgUrl="/static/img/shortstack-overflow.jpeg" />,
